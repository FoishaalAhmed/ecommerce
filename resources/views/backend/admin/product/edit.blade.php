                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="short" class="form-control textarea" >{{$product->short}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>{{__('Size Guide')}}</label>
                                        <textarea name="size_guide" id="editor2" class="form-control" >{{$product->size_guide}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
